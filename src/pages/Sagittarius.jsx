...
const Sagittarius = () => {
  ...
  const fetchHoroscope = useCallback(async (timePeriod) => {
    try {
      ...
      const apiUrl = `https://${apiHost}/api/Daily-Horoscope-English/?zodiacSign=sagittarius&timePeriod=${timePeriod}`;
  ...
  return (
    <SignPage signName="Sagittarius" backgroundColor="#BC8F8F">
